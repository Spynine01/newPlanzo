...
// Navigation component that hides on the homepage
const Navigation = () => {
    ...
    <Router>
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex-1">
          ...
          {/* Routes - Conditionally apply padding to non-landing pages */}
          <Routes>
            <Route path="/" element={<div className="p-0"><LandingPage /></div>} />
